...
var icones = angular.module("icones", []);

icones.controller("iconesCtrl", ['$scope', function ($scope) {
        $scope.focusSearch = function(){
          $("#filtro").focus();
        };
        $scope.icones = ["-action-3d-rotation", "-action-accessibility", "-action-account-balance", "-action-account-balance-wallet", "-action-account-box",
            "-action-account-child", "-action-account-circle", "-action-add-shopping-cart",
            "-action-alarm", "-action-alarm-add", "-action-alarm-off", "-action-alarm-on", "-action-android", "-action-announcement",
            "-action-aspect-ratio",
            "-action-assessment",
            "-action-assignment",
